...
namespace LitheNET.Allegro5
{
	...
	public class Keyboard
	{
		...
		[DllImport(Libraries.allegro_dll, CallingConvention = CallingConvention.Cdecl)] public static extern bool al_install_keyboard();
		[DllImport(Libraries.allegro_dll, CallingConvention = CallingConvention.Cdecl)] public static extern bool al_uninstall_keyboard();

		[DllImport(Libraries.allegro_dll, CallingConvention = CallingConvention.Cdecl)] public static extern string al_keycode_to_name(ALLEGRO_KEYS key);
		[DllImport(Libraries.allegro_dll, CallingConvention = CallingConvention.Cdecl)] public static extern bool al_set_keyboard_leds(ALLEGRO_KEYMODS leds);
		[DllImport(Libraries.allegro_dll, CallingConvention = CallingConvention.Cdecl)] public static extern IntPtr al_get_keyboard_event_source();
